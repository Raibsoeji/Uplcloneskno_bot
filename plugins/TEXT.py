...
drive_folder_name = "HelloDirectClone"


# Enter Your Mega email And Pass (Required)
MEGA_EMAIL = "htqapn4807@dhamsi.com"
MEGA_PASSWORD = "g*<XWK`wvbxnS@;t1.-~cR)\'{06}"


START = " Hi {}  \nI am Drive Uploader Bot . Please Authorise To use me .By using /auth \n\n For more info /help \n\n Third-Party Website \n Support Added /update \n\n For Bot Updates  \n <a href ='https://t.me/joinchat/sJL34nlOo40wNjI1'>Join Channel</a>\nPlease Report Bugs  @dyeuetjd"
